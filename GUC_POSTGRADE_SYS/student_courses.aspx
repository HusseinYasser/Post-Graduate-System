<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student_courses.aspx.cs" Inherits="GUC_POSTGRADE_SYSTEM.all_courses" %>
      ...
      <li class="nav-item">
        ...
        <a class="nav-link" href="student_phone.aspx">My Phones</a>
          ...
          text-decoration:underline !important;">View Courses<a>
                ...
                <li class="nav-item" style="color:greenyellow !important;margin-left:500px">
